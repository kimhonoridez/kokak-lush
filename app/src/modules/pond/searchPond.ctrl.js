(function () {
	...
	angular.module('pond')
		.controller('searchPondCtrl', ['$scope', '$state', 'AdminSvc', 'MsgPosterSvc', function ($scope, $state, AdminSvc, MsgPosterSvc) {
			var vm = this;
			...
			$scope.searchPondAdminGridOptions = {
                ...
                {
                	command: {
                		template: '<input type="button" class="btn btn-primary" value="View Details" ng-click="mate($event)"/>'
                	}, 
                	title: " ",
                	width: "250px"
                }]
